 ...
 * automatically mapped onto it. Subclasses can override {@link #initMyFrameworkServlet()}
...
public abstract class MyFrameworkServlet extends HttpServletBean implements ApplicationContextAware {
     ...
     * application context. This method allows MyFrameworkServlets to be registered as
     ...
     */
    protected void initMyFrameworkServlet() throws ServletException {
    }
