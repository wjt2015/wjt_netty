 ...
 */
@Slf4j
public abstract class MyAbstractAnnotationConfigDispatcherServletInitializer
        extends MyAbstractDispatcherServletInitializer {
    ...
    protected WebApplicationContext createRootApplicationContext() {
        ...
        log.info("configClasses={};", Arrays.asList(configClasses));
