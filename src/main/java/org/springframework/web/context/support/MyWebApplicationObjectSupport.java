 ...
 */
@Slf4j
public abstract class MyWebApplicationObjectSupport extends MyApplicationObjectSupport implements ServletContextAware {
    ...
    protected final WebApplicationContext getWebApplicationContext() throws IllegalStateException {
        ...
        if (ctx instanceof WebApplicationContext) {
            ...
            throw new IllegalStateException("MyWebApplicationObjectSupport instance [" + this +
