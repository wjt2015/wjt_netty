 ...
 */
@Slf4j
public abstract class MyApplicationObjectSupport implements ApplicationContextAware {
    ...
    public final ApplicationContext getApplicationContext() throws IllegalStateException {
        if (this.applicationContext == null && isContextRequired()) {
            throw new IllegalStateException(
                    "MyApplicationObjectSupport instance [" + this + "] does not run in an ApplicationContext");
        }
