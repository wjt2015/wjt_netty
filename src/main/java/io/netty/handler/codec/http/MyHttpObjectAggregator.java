...
import io.netty.handler.codec.MyMessageAggregator;
 ...
 *  p.addLast("aggregator", <b>new {@link MyHttpObjectAggregator}(1048576)</b>);
 *  ...
 *  p.addLast("handler", new HttpRequestHandler());
 *  </pre>
 * </blockquote>
 * <p>
 * For convenience, consider putting a {@link HttpServerCodec} before the {@link MyHttpObjectAggregator}
 * as it functions as both a {@link HttpRequestDecoder} and a {@link HttpResponseEncoder}.
 * </p>
 * Be aware that {@link MyHttpObjectAggregator} may end up sending a {@link HttpResponse}:
 ...
 */
@Slf4j
public class MyHttpObjectAggregator
        extends MyMessageAggregator<HttpObject, HttpMessage, HttpContent, FullHttpMessage> {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(MyHttpObjectAggregator.class);
