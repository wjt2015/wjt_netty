 ...
 *
 * <pre>
 *     public class SquareDecoder extends {@link MyByteToMessageDecoder} {
 *         {@code @Override}
 ...
 * one with {@link MyByteToMessageDecoder}. Ensure there are enough bytes in the buffer for a
 ...
 * <h3>Pitfalls</h3>
 * <p>
 * Be aware that sub-classes of {@link MyByteToMessageDecoder} <strong>MUST NOT</strong>
 ...
 */
@Slf4j
public abstract class MyByteToMessageDecoder extends ChannelInboundHandlerAdapter {
    ...
    protected MyByteToMessageDecoder() {
        ensureNotSharable();
    }
