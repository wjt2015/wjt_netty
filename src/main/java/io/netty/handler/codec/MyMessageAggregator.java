 ...
 */
@Slf4j
public abstract class MyMessageAggregator<I, S, C extends ByteBufHolder, O extends ByteBufHolder>
     ...
     */
    protected MyMessageAggregator(int maxContentLength) {
        validateMaxContentLength(maxContentLength);
        this.maxContentLength = maxContentLength;
    }

    protected MyMessageAggregator(int maxContentLength, Class<? extends I> inboundMessageType) {
