 ...
 *             {@link MyMessageToMessageEncoder}&lt;{@link Integer}&gt; {
 *
 *         {@code @Override}
 ...
 */
@Slf4j
public abstract class MyMessageToMessageEncoder<I> extends ChannelOutboundHandlerAdapter {
     ...
     */
    protected MyMessageToMessageEncoder() {
        matcher = TypeParameterMatcher.find(this, MyMessageToMessageEncoder.class, "I");
    }
