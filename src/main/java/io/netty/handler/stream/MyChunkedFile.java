 ...
 */
@Slf4j
public class MyChunkedFile implements ChunkedInput<ByteBuf> {
     ...
     */
    public MyChunkedFile(File file) throws IOException {
     ...
     */
    public MyChunkedFile(File file, int chunkSize) throws IOException {
     ...
     * Creates a new instance that fetches data from the specified file.
     */
    public MyChunkedFile(RandomAccessFile file) throws IOException {
        this(file, ChunkedStream.DEFAULT_CHUNK_SIZE);
    }
     ...
     *                  {@link #readChunk(ChannelHandlerContext)} call
     */
    public MyChunkedFile(RandomAccessFile file, int chunkSize) throws IOException {
     ...
     *                  {@link #readChunk(ChannelHandlerContext)} call
     */
    public MyChunkedFile(RandomAccessFile file, long offset, long length, int chunkSize) throws IOException {
        if (file == null) {
    ...
    public ByteBuf readChunk(ByteBufAllocator allocator) throws Exception {
        log.info("this.offset={};this.endOffset={};", this.offset, this.endOffset);
